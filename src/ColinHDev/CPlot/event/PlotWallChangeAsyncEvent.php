...
/**
 * This event is called when the wall of a {@see Plot} is changed by a {@see Player}.
 */
class PlotWallChangeAsyncEvent extends PlotAsyncEvent implements Cancellable {
